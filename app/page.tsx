...
const personalProjects: PersonalProject[] = [
  ...
  },
  {
    ...
    overview:
      "here&now는 취향·시간·그날의 분위기를 반영해 AI가 데이트 코스를 추천하고, 다녀온 곳을 인터랙티브 지도에 기록으로 남기는 앱인토스 미니앱입니다. 프론트엔드로 참여해 AI 추천 코스 결과 화면(네이버 지도·리스트 뷰), 장소 교체 인터랙션, 인기 공유 코스 랜덤 추천, 코스 공유/공유받기, 오류 안내 토스트와 공지사항 패널까지 핵심 사용 흐름을 구현했습니다. 설치 없이 토스에서 바로 실행되는 미니앱으로 MVP를 빠르게 검증하고, 출시 후 3차 디자인 QA를 반영하며 완성도를 높였습니다.",
    keywords: [
